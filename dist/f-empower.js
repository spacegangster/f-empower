...
define(function() {
  ...
  difference_sets = function(set_a, set_b) {
    var item, k, len3, results1;
    results1 = [];
    for (k = 0, len3 = set_a.length; k < len3; k++) {
      item = set_a[k];
  ...
  set_symmetric_difference = function(set_a, set_b) {
    return [difference_sets(set_a, set_b), difference_sets(set_b, set_a)];
  };
  equal = function() {
    var val;
